...
const gameProjectionsRouter = require('./routes/game-projections');
const lineupsRouter = require('./routes/lineups');
const playerStatsRouter = require('./routes/player-stats');
...
app.use('/game-projections',gameProjectionsRouter);
